  ...
  upload(event) {
    ...
    this.timeout = setTimeout(async () => {
      try {
        ...
        if (!response.ok) {          
          errorBox.classList.remove('text-green-500', 'p-2', 'border', 'border-green-500', 'rounded-md', 'mb-2');
          errorBox.classList.add('text-red-500', 'p-2', 'border', 'border-red-500', 'rounded-md', 'mb-2');
        ...
        if (jsonResponse.valid) {
          errorBox.classList.remove('text-red-500', 'p-2', 'border', 'border-red-500', 'rounded-md', 'mb-2');
          errorBox.classList.add('text-green-500', 'p-2', 'border', 'border-green-500', 'rounded-md', 'mb-2');
